...
brand_list = ["L-COM", "Fairview", "Pasternack", "ShowMeCables", "Transtector"]
...
if brand_choice == "Pasternack":
    my_paths = {
        glob.glob(os.path.join(source, "*_500x334_View1*"), recursive=True)[
            0
        ]: "/Users/drewh/OneDrive/Documents/FastPhoto/"
        + brand_choice
        + "/500x334",
        glob.glob(os.path.join(source, "*_250x167_View1*"), recursive=True)[
            0
        ]: "/Users/drewh/OneDrive/Documents/FastPhoto/"
        + brand_choice
        + "/250x167",
        glob.glob(os.path.join(source, "*_100x67_View1*"), recursive=True)[
            0
        ]: "/Users/drewh/OneDrive/Documents/FastPhoto/"
        + brand_choice
        + "/100x67",
    ...
    my_paths = {
        glob.glob(os.path.join(source, "*_500x500_View1*"), recursive=True)[
            0
        ]: "/Users/drewh/OneDrive/Documents/FastPhoto/"
        + brand_choice
        + "/500x500",
        glob.glob(os.path.join(source, "*_250x250_View1*"), recursive=True)[
            0
        ]: "/Users/drewh/OneDrive/Documents/FastPhoto/"
        + brand_choice
        + "/250x250",
        glob.glob(os.path.join(source, "*_100x100_View1*"), recursive=True)[
            0
        ]: "/Users/drewh/OneDrive/Documents/FastPhoto/"
        + brand_choice
        + "/100x100",
